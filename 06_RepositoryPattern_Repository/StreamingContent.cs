...
namespace _06_RepositoryPattern_Repository
{
    ...
    public enum GenreType
    {
        ...
        Action 
            ...
            // In the list above "Horror", assigigning the value of 1, which then in turn reassigns the values of the rest of the items in the list in force ranked order
    ...
    public class StreamingContent 
    {
        ...
        public GenreType TypeOfGenre { get; set; } // Note on naming convention here: property type (GenreType (Our enu above)), value of property type (TypeOfGenre), flip order of name because cannot name the same
        public StreamingContent() { } // Empty constructor
        public StreamingContent(string title, string description, string maturityRating, double starRating, bool isFamilyFriendly, GenreType genre) // Overloaded constructor
        {
            ...
            // However, the parameters are defined in the constructor public StreamingContent (title, descprtion, maturityRating, startRating, isFamily, genre) so we cannot use these parameters in the other ..
            // ..constructor in the class, because it does not exist in that context. I.e., we cannot start with the parameters and work outward, we can on start outward, and drill down inward. 
